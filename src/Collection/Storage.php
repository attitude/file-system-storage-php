...
final class Storage {
   ...
   *
   * @param string|array|\stdClass $identifier The identifier to convert.
   * @return Entry The converted Entry object.
   */
  protected function identifiersKeyValue(string|array|\stdClass $identifier): Entry {
    if (is_array($identifier) || is_object($identifier)) {
      return $this->identifiers->parse($identifier);
    } else {
   ...
   *
   * @param string|array|\stdClass $identifier The identifier to retrieve the value for.
   * @return mixed The value associated with the identifier.
   */
  public function get(string|array|\stdClass $identifier): mixed {
   ...
   *
   * @param array|\stdClass $value The value to store.
   * @return string The key associated with the stored value.
   */
  public function store(array|\stdClass $value): string {
   ...
   *
   * @param string|array|\stdClass $identifier The identifier to delete the value for.
   * @return void
   */
  public function delete(string|array|\stdClass $identifier): void {
   ...
   *
   * @param string|array|\stdClass $identifier The identifier to check.
   * @return bool True if a value is associated with the identifier, false otherwise.
   */
  public function has(string|array|\stdClass $identifier): bool {
